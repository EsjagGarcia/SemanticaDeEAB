...
instance Show Expr where
 show e = case e of
   ...
   (Mul e1 e2) -> "mul(" ++ (show e2) ++ "," ++ (show e2) ++ ")"
   (Succ e) -> "succ(" ++ (show e) ++ ")"
   (Pred e) -> "pred(" ++ (show e) ++ ")"
   (Not e) -> "not(" ++ (show e) ++ ")"
   (And e1 e2) -> "and(" ++ (show e2) ++ "," ++ (show e2) ++ ")"
   (Or e1 e2) -> "or(" ++ (show e2) ++ "," ++ (show e2) ++ ")"
   (Lt e1 e2) -> "lt(" ++ (show e2) ++ "," ++ (show e2) ++ ")"
   (Gt e1 e2) -> "gt(" ++ (show e2) ++ "," ++ (show e2) ++ ")"
   (Eq e1 e2) -> "eq(" ++ (show e2) ++ "," ++ (show e2) ++ ")"
